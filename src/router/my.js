...
const mys = [].concat(pinDetails, myget, my, marketingMgt, address, order, orderDetails, orderSubDetail, applyCustomer, refund, logistics, after,refundDetails, barter, barterDetails, shopList)
module.exports = mys
