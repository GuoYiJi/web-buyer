...
<template>
  <!-- 拼团待收货状态状态 -邮寄（子订单） 版本1 -->
  <div class="home">
      <div class="head">
        <div class="pin-completemsg">
            <i class="icon"></i>
            <span class="pinmsg">拼团成功，待收货（还剩12天2小时自动确认收货）</span>
        </div>
      </div>
    ...
    <div class="below">
      <div class="total">
        <p class="t-left">共
          <span class="piece">3</span> 个款
          </p>
        <p class="t-left">
          <span class="piece">86</span> 个商品
          </p>
     ...
     <div class="prices">
      ...
      <div class="serial">
        <p class="s-text">父订单编号：2018062712345678904</p>
        <p class="s-text">订单编号：2018062712345678904</p>
        <p class="s-text">下单时间：2018-06-16 12:27:12</p>
        <p class="s-text">支付时间：2018-06-16 12:27:12</p>
        <p class="s-text">拼团时间：2018-06-16 12:27:12</p>
        <p class="s-text">发货时间：2018-06-16 12:27:12</p>

      </div>
    </div>
    <div class="btn-Two">
           <div class="n-perTwo">
            <img class="m-perImg m-perImg2" src="http://www.qckj.link/upload/goods/20180520/1526794348353_160563.jpg">
            <img class="m-perImg" src="http://www.qckj.link/upload/goods/20180520/1526794348353_160563.jpg">
            <img class="m-perImg" src="http://www.qckj.link/upload/goods/20180520/1526794348353_160563.jpg">
          </div>
          <div class="btn">
            <span class="b-xq" @click="toOpen('visible2')">确认收货</span>
            <span class="b-sc" @click="toOpen('visible2')">查看物流</span>
            <span class="b-sc" @click="toOpen('visible2')">申请售后</span>
          </div>
    </div>
  </div>
</template>
