...
export default {
  ...
  computed: {
    currentStyle() {
      const index = this.styleNames.findIndex(e => e === this.Warehouse.styleName);
      if (index !== -1) {
        return this.styleNames[index];
      }
      return this.styleNames[this.styleNames.length - 1];
